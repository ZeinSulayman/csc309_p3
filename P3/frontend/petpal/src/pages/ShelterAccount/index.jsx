                    ...
                    <form action="./shelter-manage.html" onSubmit={submit}>
                        <div class="card-body text-center">
                            <img src="./img/shelter-logo.png" alt="avatar"
                                ...
                                <input type="text" class="my-3"  value={name} onChange={e => setName(e.target.value)} required></input>
                            ...
                            <textarea rows="2" class="mb-2" id value={bio} onChange={e => setBio(e.target.value)} required></textarea>
                        </div>
                ...
                <div class="card  h-100">
                    <div class="card-body">
                        <div class="row"    >
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="text-muted mb-0"  value={name} onChange={e => setName(e.target.value)}></input>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="text-muted mb-0" value="animal@shelter.com"></input>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="text-muted mb-0" value={num} onChange={e => setNum(e.target.value)}></input>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="text-muted mb-0" value={loc} onChange={e => setLoc(e.target.value)}></input>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="text-muted mb-0" value="Smith Don"></input>
                            </div>
                        </div>
                    </div>
                </div>
